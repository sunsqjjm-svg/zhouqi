...
# ================= 页面顶部：精简去重后的全池实时雷达看板 =================
with st.spinner("⚡ 正在扫描 26 只周期股实时极值动能..."):
...
if user_input:
    ...
    if not info:
        ...
        try:
            ...
            with tab_long:
                st.caption(f"10年客观估值中枢（底部PB {pb_floor:.2f} ~ 顶部PB {pb_cap:.2f}）。鼠标滑过可同时查看【风险读数】与【真实市净率PB】。")
